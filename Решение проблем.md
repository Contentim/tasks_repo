...
"objects_access": ",personnel_document_type,personnel_document,attorney,",
            
"recommended_service", // Рекомендательный сервис
"objects_access": ",object_link,user_recommendation,recommender_select_collaborator,presence_state,",
            
"collaborator_schedule", // График сотрудника
"objects_access": ",collaborator_schedule,schedule_day,schedule_type,presence_state,check_schedule,restricting_type,absence_reserve,restricting_collaborator_schedule,policy_type,policy,interval_schedule,vacation_day,",
            
"wiki", // Wiki
"objects_access": ",wiki_base,wiki_article,wiki_article_communication,",
            
"mobile", // Мобильный WebSoft HCM
"objects_access": ",mobile_app_config,device_reg,workspace_config,",
            
"proctoring", // Прокторинг
"objects_access": ",learning_record,event,assessment,proctoring_system,",
            
"chatbots", // Чат-боты
"objects_access": ",chatbot,chatbot_stage,chatbot_chat,chatbot_type,chat,conversation,block_message,conversation_type,custom_chatbot_template,call,web_person_state,personal_assistant,ai_model,conversation_participant,",
            
"exs", // Обмен данными
"objects_access": ",exchange_server,upload_package,system_event,certificate_type,operation,plugin,file_source,",
            
"crmsale", // CRM
"objects_access": ",sale,provider,sale_status,sale_contract_type,messenger_service,pay_stage,fact_payment,sale_contract,price,expense,closing_document,dimension,contract_state,closing_document_status,",
            
"secur", // Безопасность
"objects_access": ",access_role,boss_type,admin_access_catalog,digital_signature,credential,remote_security_profile,remote_application,license,person_object_link,person_object_profile,object_claim,",
            
"prize", // Премирование
